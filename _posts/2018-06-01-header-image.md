...
<div align=center><img src="https://i.postimg.cc/dtgnfZXf/1.png"  width = "480" height = "400" /></div>
...
<div align=center><img src="https://i.postimg.cc/bN6sT4CY/2.png"  width = "480" height = "400" /></div>
...
\end{matrix}
\right)$$
$\left(\lambda_1, \lambda_2, \cdots,\lambda_m \right)$是协方差矩阵的特征值，分别对应 $m$ 个正交的单位向量。
实对称矩阵有三个性质：
- 实对称矩阵的特征值都是实数
