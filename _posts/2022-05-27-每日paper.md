...
- 完善评测代码后，验证：
  ...
  - (CCAM-Neg-Last2BLK-1.0T)的作用
    ...
    - GPTR-(CCAM-Neg-Last2BLK-1.0T)-(RS-RC-CJ)-(BatchSize-128-2)  &#9745;  
  ...
  - (CCAM-Neg-Last2BLK-1.0T) 赋予不同的权重，**验证CCAM_loss的权重是不是会出现GT_loc达到峰值再下降的原因。**
    - GPTR-(CCAM-Neg-Last2BLK-1.0T-w-0.2)-(RS-RC-CJ)-(BatchSize-64-2)  &#9745;
    - GPTR-(CCAM-Neg-Last2BLK-1.0T-w-0.6)-(RS-RC-CJ)-(BatchSize-100-2)  &#9745;
