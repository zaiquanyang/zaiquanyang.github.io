...
`AdaptSegNet`--`Learning to Adapt Structured Output Space for Semantic Segmentation` <br>
`BDL` -- `Bidirectional Learning for Domain Adaptation of Semantic Segmentation` <br>
