...
- 关于高斯分布的均值和方差的值的计算
  ...
  <div align=center><img src="https://i.postimg.cc/QMN8pYSx/QQ-20210923120240.png" width="600"></div>

- 关于损失函数**Transferable CrossEntropy Loss**的推导

  <div align=center><img src="https://i.postimg.cc/wxLVmwrm/QQ-20210923115559.png" width="600"></div>
...
- 实验分析
  ...
  - 作者将**TSA**插件应用到之前的方法中，均获得了明显的提升。
    ...
    <div align=center><img src="https://i.postimg.cc/GhhngTGq/QQ-20210923121130.png" width=800"></div> 

  - 消融实验
  
  下图是验证基于类均值的高斯分布采样更有利用域适应学习，但是没有**mutual information minimizing loss**， **TSA**好像也就比**ISDA**强一点。

  <div align=center><img src="https://i.postimg.cc/wTJ4V6b0/QQ-20210923121559.png" width="600"></div>

  此外作者还验证了自己将**ISDA**的迭代更新方差修改为只计算当前batch的方差对模型的性能提升。

  <div align=center><img src="https://i.postimg.cc/fRDCfYdR/QQ-20210923122214.png" width="600"></div>
...
[41] Deep feature interpolation for image content changes, CVPR2017
