...
[参考一](https://blog.csdn.net/qxqxqzzz/article/details/104275779)
[参考二](https://blog.csdn.net/weixin_40198632/article/details/78472015)
...
# 保存
plt.tight_layout()
fig.savefig("cub_bar3_hyp.png", bbox_inches='tight', pad_inches=0, dpi=800)
# plt.close(fig)
